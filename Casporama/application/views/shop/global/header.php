<header>
    ...
    <a href="<?= base_url("/Shop/view/" . $sport . "/Vetement") ?>"><h2>Vêtements</h2></a>
    ...
    <nav class="nav">
            ...
            <div class="right">
                <ul class="list_nav">
                    <li class="text">Vêtements</li>
                    <li class="text">Chaussures</li>
                    <li class="text">Equipements</li>
                    <div class="list_line">
                        <hr>
                    </div>
                    <li class="icon list_icon"><img src="img/shop.png"></li>
