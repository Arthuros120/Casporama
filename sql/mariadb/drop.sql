...
drop procedure if exists captcha;

drop procedure if exists catalog;

drop procedure if exists catalogue;

drop procedure if exists cleanCaptchat;

drop procedure if exists commande;
...
drop procedure if exists produit;

drop procedure if exists setCookieId;

drop procedure if exists sport;
...
drop procedure if exists verifyId;
